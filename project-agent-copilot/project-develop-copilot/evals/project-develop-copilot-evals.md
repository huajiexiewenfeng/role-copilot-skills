...
- Module coverage checks: `missing-module-context` and `incomplete-module-context` should be WARN findings and should lower `score/report` module coverage signals without blocking by default.
